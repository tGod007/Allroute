# Generated by Django 4.2.16 on 2025-03-03 15:40
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.TextField(
                        blank=True, help_text="e.g., wheelchair access", null=True
                    ),
                ),
                (
                    "preferred_routes",
                    models.TextField(
                        blank=True, help_text="e.g., Lagos to Abuja", null=True
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("providers", models.ManyToManyField(to="accounts.transportprovider")),
                (
                    "user",
                    models.ForeignKey(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("tickets", models.ManyToManyField(to="accounts.ticket")),
                (
                    "user",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE,
